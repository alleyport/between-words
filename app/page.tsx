...
const bottomStars = [
  "left-[-70px] bottom-[-20px] w-[420px] rotate-[-5deg] opacity-95",
  "left-[14%] bottom-[8px] w-[360px] rotate-[7deg] opacity-85",
  "left-1/2 bottom-[-18px] w-[500px] -translate-x-1/2 rotate-[-2deg] opacity-95",
  "right-[13%] bottom-[10px] w-[360px] rotate-[-7deg] opacity-85",
  "right-[-76px] bottom-[-20px] w-[440px] rotate-[6deg] opacity-95"
];
...
export default function HomePage() {
  return (
    ...
    >
      <img src="/images/home/decorative-star-1.png" alt="" className="absolute left-[8%] top-[13%] w-[clamp(95px,8vw,160px)] rotate-[-10deg] opacity-70 drop-shadow-[0_10px_16px_rgba(58,38,28,0.16)]" />
      <img src="/images/home/decorative-star-2.png" alt="" className="absolute right-[10%] top-[15%] w-[clamp(95px,8vw,160px)] rotate-[9deg] opacity-68 drop-shadow-[0_10px_16px_rgba(58,38,28,0.16)]" />
      <img src="/images/home/decorative-wax-stamp.png" alt="" className="absolute right-[24%] top-[50%] z-20 w-[clamp(95px,7vw,150px)] rotate-[-7deg] opacity-78 drop-shadow-[0_13px_18px_rgba(58,38,28,0.26)]" />
      ...
      <div className="relative z-10 h-full px-6 text-center">
        ...
        <div className="absolute left-1/2 top-[38svh] aspect-[1.45/1] w-[clamp(520px,42vw,760px)] max-w-[92vw] -translate-x-1/2 -translate-y-1/2 bg-[url('/images/home/center-art-rectangle.png')] bg-contain bg-center bg-no-repeat drop-shadow-[0_20px_32px_rgba(58,38,28,0.24)]">
          <p className={`${handwrittenFont.className} absolute left-[17%] top-[31%] w-[66%] text-[clamp(2rem,2.8vw,3.2rem)] leading-[1.1] tracking-[0.035em] text-[#3A261C]`}>
